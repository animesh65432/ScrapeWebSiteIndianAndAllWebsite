...
config = {
    ...
    "NORTH_SCARPER_AND_NORTHEAST_INDIA_API_TOEKN": os.getenv("NORTH_SCARPER_AND_NORTHEAST_INDIA_API_TOEKN"),
    "CENTRAL_INDIA_AND_EAST_INDIA_SCARPER_API_TOEKN" : os.getenv("CENTRAL_INDIA_AND_EAST_INDIA_SCARPER_API_TOEKN"),
    "SOUTH_INDIA_AND_WEST_INDIA_API_TOKEN" : os.getenv("SOUTH_INDIA_AND_WEST_INDIA_API_TOKEN"),
    "SCARPER_API_TOKEN": os.getenv("SCARPER_API_TOKEN"),
    "CLOUDFARE_MODEL_ACCOUNT_ID" : os.getenv("CLOUDFARE_MODEL_ACCOUNT_ID"),
    "CLOUDFARE_MODEL_API_TOKEN" : os.getenv("CLOUDFARE_MODEL_API_TOKEN"),
    ...
    "PUBLIC_IP_ADRESS" : os.getenv("PUBLIC_IP_ADRESS")
}
