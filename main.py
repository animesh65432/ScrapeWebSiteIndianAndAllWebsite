import asyncio
from Scrape import scarpe_westBengal_Annoucements ,scarpe_Assam_Annoucements,scrap_Dehli_Website,scrape_Goa_Annoucements,scapre_HimachalPradesh_Annoucements,scrape_ArunachalPradesh_Annoucements ,ScrapeChhattisgarhAnnoucement
...
async def scrape_all_states():
    ...
    print(await ScrapeChhattisgarhAnnoucement())
